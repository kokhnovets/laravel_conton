...
@section('main')
<div class="container">
    <h2 class="h2 mt-5 mb-5">Политика конфиденциальности персональных данных</h2>
    <p>Настоящая Политика конфиденциальности персональных данных (далее – Политика конфиденциальности) действует в
        отношении всей информации, которую сайт <strong>Сервис для покупки и доставки товаров через путешественников</strong>, (далее – conton.com) расположенный на
        доменном имени <strong>conton.com</strong> (а также его субдоменах), может получить о Пользователе во время использования
        сайта conton.com (а также его субдоменов), его программ и его продуктов.</p>

    <h2 class="h2 mt-5 mb-5">1. Определение терминов</h2>

    <p>1.1 В настоящей Политике конфиденциальности используются следующие термины:</p>

        <p>1.1.1. «<strong>Администрация сайта</strong>» (далее – Администрация) – уполномоченные сотрудники
            на управление сайтом <strong>Сервис для покупки и доставки товаров через путешественников</strong>, действующие от имени ООО "Кантон",
        ...
        <p>1.1.5. «Сайт <strong> Сервис для покупки и доставки товаров через путешественников</strong>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному
            адресу (URL): <strong>conton.com</strong>, а также его субдоменах.</p>

        <p>1.1.6. «Субдомены»  - это страницы или совокупность страниц, расположенные на доменах третьего уровня,
            принадлежащие сайту Сервис для покупки и доставки товаров через путешественников, а также другие временные страницы, внизу который указана контактная
            информация Администрации</p>

        <p>1.1.5. «Пользователь сайта <strong>Сервис для покупки и доставки товаров через путешественников</strong> » (далее Пользователь) – лицо, имеющее доступ
            к сайту <strong>Сервис для покупки и доставки товаров через путешественников</strong>, посредством сети Интернет
            и использующее информацию, материалы и продукты сайта <strong>Сервис для покупки и доставки товаров через путешественников</strong>.</p>
        ...
        <h2 class="h2 mt-5 mb-5">2. Общие положения</h2>
        <p>2.1. Использование сайта Сервис для покупки и доставки товаров через путешественников Пользователем означает согласие с настоящей Политикой
        ...
        <p>2.2. В случае несогласия с условиями Политики конфиденциальности Пользователь должен прекратить использование
            сайта Сервис для покупки и доставки товаров через путешественников .</p>

        <p>2.3. Настоящая Политика конфиденциальности применяется к сайту Сервис для покупки и доставки товаров через путешественников.
            conton.com не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь
            может перейти по ссылкам, доступным на сайте Сервис для покупки и доставки товаров через путешественников.</p>

        <p>2.4. Администрация не проверяет достоверность персональных данных, предоставляемых Пользователем.</p>

        <h2 class="h2 mt-5 mb-5">3. Предмет политики конфиденциальности</h2>
        ...
        <p>3.1. Настоящая Политика конфиденциальности устанавливает обязательства Администрации по неразглашению и обеспечению
            ...
            регистрации на сайте Сервис для покупки и доставки товаров через путешественников, при подписке на информационную e-mail рассылку или при оформлении заказа.</p>

        <p>3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются
            Пользователем путём заполнения форм на сайте Сервис для покупки и доставки товаров через путешественников и включают в себя следующую информацию:<br>
        ...
        <p>3.3. conton.com защищает Данные, которые автоматически передаются при посещении страниц:<br>
            - IP адрес;<br>
        ...
        <p>3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта <!--?php echo Сервис для покупки и доставки товаров через путешественников ?-->, требующим
            авторизации.</p>

        <p>3.3.2. conton.com осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация
        ...
        <h2 class="h2 mt-5 mb-5">4. Цели сбора персональной информации пользователя</h2>

        <p>4.1. Персональные данные Пользователя Администрация может использовать в целях:<br>
            4.1.1. Идентификации Пользователя, зарегистрированного на сайте Сервис для покупки и доставки товаров через путешественников для его дальнейшей авторизации, оформления заказа
            и других действий.<br>

            4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта Сервис для покупки и доставки товаров через путешественников.<br>

            4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся использования
            сайта Сервис для покупки и доставки товаров через путешественников, оказания услуг и обработки запросов и заявок от Пользователя.<br>

            4.1.4. Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.<br>

            4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br>

            4.1.6. Создания учетной записи для использования частей сайта Сервис для покупки и доставки товаров через путешественников, если Пользователь дал согласие на
            ...
            сайта Сервис для покупки и доставки товаров через путешественников.<br>
        ...
        <h2 class="h2 mt-5 mb-5">5. Способы и сроки обработки персональной информации</h2>
        ...
        <p>5.2. Пользователь соглашается с тем, что Администрация вправе передавать персональные данные третьим лицам, в
            ...
            исключительно в целях выполнения заказа Пользователя, оформленного на сайте Сервис для покупки и доставки товаров через путешественников, включая доставку Товара,
        ...
        <h2 class="h2 mt-5 mb-5">6. Права и обязанности сторон</h2>
        ...
        <p>6.1.1. Принимать свободное решение о предоставлении своих персональных данных, необходимых для использования
            сайта Сервис для покупки и доставки товаров через путешественников, и давать согласие на их обработку.</p>
        ...
        <h2 class="h2 mt-5 mb-5">7. Ответственность сторон</h2>
        ...
        <p>7.4. Пользователь признает, что ответственность за любую информацию (в том числе, но не ограничиваясь: файлы с данными,
            тексты и т. д.), к которой он может иметь доступ как к части сайта Сервис для покупки и доставки товаров через путешественников, несет лицо, предоставившее
            такую информацию.</p>

        <p>7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта Сервис для покупки и доставки товаров через путешественников, может
            являться объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям,
            партнерам или рекламодателям, которые размещают такую информацию на сайте Сервис для покупки и доставки товаров через путешественников. <br>
        ...
        <p>7.6. В отношение текстовых материалов (статей, публикаций, находящихся в свободном публичном доступе на
            сайте Сервис для покупки и доставки товаров через путешественников) допускается их распространение при условии, что будет дана ссылка
            на conton.com.</p>
        ...
        <p>7.7. Администрация не несет ответственности перед Пользователем за любой убыток или ущерб, понесенный Пользователем
            ...
            содержащихся на сайте Сервис для покупки и доставки товаров через путешественников или передаваемых через него.</p>
        ...
        <p>7.9. Администрация не несет ответственность за какую-либо информацию, размещенную пользователем на
            сайте Сервис для покупки и доставки товаров через путешественников, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого
            согласия владельца авторского права.</p>

        <h2 class="h2 mt-5 mb-5">8. Разрешение споров</h2>
        ...
        <h2 class="h2 mt-5 mb-5">9. Дополнительные условия</h2>
        <p>9.1. Администрация вправе вносить изменения в настоящую Политику конфиденциальности без согласия Пользователя.</p>

        <p>9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте Сервис для покупки и доставки товаров через путешественников, если
        ...
        <p>9.3. Все предложения или вопросы касательно настоящей Политики конфиденциальности следует сообщать по
            адресу: help@conton.com</p>

        <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу http://conton.com/policy</p>

        <p>Обновлено: 06  2022 года</p>
        <p>г. Москва, ООО "Кантон", ОГРН 4349384944</p>
    </div>
</div>
@endsection
